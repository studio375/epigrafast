...
export default function ContattiClient({page}){
    useEffect(() => {
        commonAnimations();
    });
    return <>
        ...
        <section className="relative flex flex-wrap items-stretch gap-2 mb-14 max-s:mb-5 boxed">
            <div className="box-animation w-full flex flex-col items-center justify-center gap-6 max-[600px]:gap-3 px-[115px] max-l:px-5 max-xs:px-2 bg-[#F1F3F5] s:min-h-40 max-s:py-4 rounded-[20px]">
            ...
            <div className="box-animation relative w-[calc(50%-10px)] max-[850px]:w-full flex flex-col items-start py-18 max-l:py-10 max-s:py-4 pl-15 max-[1680px]:px-10 max-l:px-5 max-xs:px-2 gap-3 max-xl:gap-[15px] bg-[#F1F3F5] rounded-[20px]">
            ...
            <div className="box-animation relative min-h-40 max-s:min-h-30 w-[calc(50%-10px)] max-[850px]:w-full rounded-[20px] flex overflow-hidden">
