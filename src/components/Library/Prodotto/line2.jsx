...
export default function Line2({...props}){
    return <div id="line-2-container" {...props} >
        <Image id="camion-2" className="show-on-scroll absolute left-0 top-5 rotate-[68deg] -translate-x-[50%] -translate-y-[50%] max-[1400px]:w-20 max-[1150px]:min-w-15 max-[1150px]:rotate-[90deg] max-[1150px]:hidden" src={'/camion.svg'} width={297} height={139} alt="furgone" />
