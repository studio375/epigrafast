...
export default function Line2(){
    return <div id="line-2-container" className="absolute left-40 top-[calc(100%-110px)] z-0">
        <Image id="camion-2" className="show-on-scroll absolute left-0 top-5 rotate-[68deg] -translate-x-[50%] -translate-y-[50%]" src={'/camion.svg'} width={297} height={139} alt="furgone" />
        <svg xmlns="http://www.w3.org/2000/svg" width="915" height="858" viewBox="0 0 915 858" fill="none">
