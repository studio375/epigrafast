...
export default function Line1({...props}){
    return <div id="line-1-container" {...props}>
        <Image id="plane-1" className="show-on-scroll rotate-[135deg] -scale-y-100 absolute right-0 top-0 -translate-y-[50%] -translate-x-[50%] opacity-0 max-[1400px]:w-18 max-[1150px]:min-w-13 max-s:hidden" src={'/plane.svg'} width={213} height={118} alt="plane"/>
        <svg className="hidden min-[1150px]:block" xmlns="http://www.w3.org/2000/svg" width="470" height="1224" viewBox="0 0 470 1224" fill="none">
        ...
        <svg className="min-[1150px]:hidden" xmlns="http://www.w3.org/2000/svg" width="29" height="278" viewBox="0 0 29 278" fill="none">
