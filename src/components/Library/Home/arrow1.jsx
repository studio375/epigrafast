...
export default function Arrow1({...props}){
    ...
    return <div id="step1-anim" {...props}>
        <Image id="plane-step-1" className={`absolute translate-y-[-50%] translate-x-[-50%] ${isMobile?'show-on-scroll':'opacity-0'} max-xl:w-11 h-auto max-xl:translate-x-[-100%] max-l:w-8 max-l:translate-x-[-150%] max-m:min-w-15 max-m:-translate-x-[50%] max-s:hidden`} src={'/plane.svg'} width={141} height={78} alt="aereoplano di carta"/>
        <svg className="max-xl:w-22 max-l:w-19 hidden m:block" xmlns="http://www.w3.org/2000/svg" width="287" height="100" viewBox="0 0 287 100" fill="none">
