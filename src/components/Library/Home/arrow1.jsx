...
export default function Arrow1(){
    return <div id="step1-anim" className="absolute left-45">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="287" height="100" viewBox="0 0 287 100" fill="none">
            ...
            <path className="draw-line" d="M284.5,27.8539C260.5,13.3538 216,-9.14615 167,7.85385C118,24.8538 118.5,91.3539 146,97.3539C173.5,103.354 158.5,39.5677 106,39.5677C30.5,39.5677 11.8333,69.0999 2,81.2666" stroke="#111111" strokeWidth="6" strokeMiterlimit="8.15" strokeLinecap="round"/>
        </svg>
    </div>
}