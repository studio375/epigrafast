...
export default function Arrow3(){
    return <div className="absolute left-[50%] top-150">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="355" height="483" viewBox="0 0 355 483" fill="none">
            <path id="last-line" className="opacity-0" d="M86.5 2C105.5 177.5 319 82 350 231C381 380 101.5 326.5 2 481" stroke="#C19B39" strokeWidth="4" strokeMiterlimit="8.15" strokeLinecap="round" strokeDasharray="15 18"/>
        </svg>
    </div>
}