...
export default function Arrow2({...props}){
    ...
    return <div id="step2-anim" {...props}> 
        <Image id="camion-step-2" className={`absolute right-[100%] translate-y-[-100%] ${isMobile?'show-on-scroll':'opacity-0'} min-[1680px]:min-w-16 max-xl:w-15 h-auto max-l:w-10 max-m:min-w-17 max-m:rotate-[90deg] max-m:-translate-x-[20%] max-s:hidden`} src={'/camion.svg'} width={214} height={100} alt="furgone"/>
        <svg className="max-w-full hidden m:block" xmlns="http://www.w3.org/2000/svg" width="415" height="4" viewBox="0 0 415 4" fill="none">
