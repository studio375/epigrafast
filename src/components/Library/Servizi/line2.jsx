export default function Line2({...props}){
    return <>
        ...
        <svg {...props} className={`m:hidden ${props.className || ''}`} xmlns="http://www.w3.org/2000/svg" width="128" height="324" viewBox="0 0 128 324" fill="none">
            ...
            <path className="draw-line" d="M122.8,322.5C133.484,261.898 122.8,209.654 96.5011,163.68C70.2018,117.705 -14.5651,130.244 2.81123,163.68C27.138,210.49 147.984,108 122.8,1.00024" stroke="#fff" strokeWidth="4" strokeMiterlimit="8.15" strokeLinecap="round"/>
        </svg>
    </>
}