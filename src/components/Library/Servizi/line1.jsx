...
export default function Line1({...props}){
    return <div id="line-1-container" {...props}>
        <Image id="plane-1" className="h-auto show-on-scroll absolute top-0 left-0 -translate-y-[50%] -translate-x-[50%] origin-center rotate-[135deg] -scale-y-100 max-xl:w-20 max-l:w-15 max-m:min-w-10" src={'/plane.svg'} width={236} height={131} alt="aereoplano" />
        ...
        <svg className="m:hidden" xmlns="http://www.w3.org/2000/svg" width="33" height="278" viewBox="0 0 28 283" fill="none">
            ...
            <path className="draw-line" d="M17.5863,281.5C53.109,167.894 -33.5145,184.657 17.5866,1.00025" stroke="#fff" strokeWidth="2" strokeMiterlimit="8.15" strokeLinecap="round"/>
        </svg>
    </div>
}